...
<BottomNav position="fixed" innerDiv="grid-cols-4" outerDiv="visible lg:invisible">
	...
	<BottomNavItem btnName="Movies">
		<a href="/movies"> 
		<svg  class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
