...
<a
	...
	class="flip-card rounded-xl md:h-[415px]  h-80 w-full md:mt-0 mt-4 drop-shadow-2xl bg-white hover:-translate-y-2"
>
	<div class="flip-card-inner ">
		<div class="flip-card-front overflow-hidden">
			<img
				...
				id={movie.id}
				loading="lazy"
				class="rounded-xl object-cover w-[calc(100%-16px)] aspect-4/5 m-2"
			...
			<div class="flex flex-col items-start m-2 w-full">
				...
				<div
					class="font-bold mt-2 text-lg inline-block overflow-hidden rounded-xl text-ellipsis w-full h-14"
				>
					{movie.title}
				</div>
			</div>
		...
		<div class="flip-card-back">
			...
			<div class="px-4 pt-2 font-medium">Overview</div>
			<div class="px-4 py-1">
				{movie.overview}
			</div>
		</div>
