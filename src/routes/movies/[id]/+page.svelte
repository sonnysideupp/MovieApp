...
{#if movie}
	<div class="flex flex-col items-center w-full">
		<img
			class="lg:mt-16 mt-8 h-[500px] object-cover w-full"
			...
			<div class="flex lg:flex-row justify-between flex-col">
				<div class="flex flex-col lg:w-7/10 w-full">
					...
					<div class="flex flex-row items-center flex-wrap px-6 pt-3">
						...
						{#each movie.genres as genre (genre.id)}
							<button
								class="bg-gray-100 py-1  px-2 rounded-lg border-2 border-gray-200 hover:bg-gray-200 mt-4 text-gray-500 mr-2"
							>
								{genre.name}
							</button>
						{/each}
					...
					<div class="pl-6 text-2xl pt-6 font-medium text-gray-500">Overview</div>
					<div class="text-lg px-6 pt-2">
						{movie.overview}
					</div>

					<div class="pl-6 text-2xl pt-6 font-medium text-gray-500">Cast</div>
					...
					<div class="pl-6 text-2xl pt-6 font-medium text-gray-500">Director</div>
							...
							<div class="flex flex-col items-center justify-start pr-4 py-2 w-28 h-24">
								<img
									...
									src={director.profile_path
										? `https://www.themoviedb.org/t/p/w276_and_h350_face/${director.profile_path}`
										: '/blankProfile.png'}
								/>
				...
				<div class="flex flex-col lg:-mt-60 mt-2 px-6 lg:px-0 lg:w-64 lg:mr-6">
					<img
						...
						alt={movie.name}
						id={movie.id}
						class="rounded object-cover w-64 h-96 mb-2 lg:block hidden"
						src={movie.poster_path
							? `https://image.tmdb.org/t/p/w500${movie.poster_path}`
							: '/fallbackMoviePoster.png'}
					/>

					<div class="flex flex-row justify-between mt-5 mr-4">
						<div class="font-semibold text-lg text-gray-500">Release date</div>
					...
					<div class="flex flex-row justify-between mt-5 mr-4">
						<div class="font-semibold text-lg text-gray-500">Runtime</div>
					...
					{#if movie.original_language}
						<div class="flex flex-row justify-between mt-5 mr-4 ">
							<div class="font-semibold text-lg text-gray-500">Original Language</div>
					...
					{#if movie.budget}
						<div class="flex flex-row justify-between mt-5 mr-4">
							<div class="font-semibold text-lg text-gray-500">Budget</div>
					...
					{#if movie.revenue}
						<div class="flex flex-row justify-between mt-5 mr-4">
							<div class="font-semibold text-lg text-gray-500">Revenue</div>
